...
<head>
  ...
  <title>Final Reminder: Account Deletion Tomorrow — SchoolLedger</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .e-btn { display: inline-block; padding: 14px 36px; border-radius: 8px; font-size: 15px; font-weight: 600; text-decoration: none; letter-spacing: .01em; background: #dc2626; color: #fff; }
  ...
  <div class="e-wrap">
    <div class="e-inner">
      ...
      <div class="e-hero">
        ...
        <h1>Final Reminder: Deletion Tomorrow</h1>
        <p>The SchoolLedger account for <strong><?= esc($school_name) ?></strong> will be <strong>permanently deleted tomorrow</strong>. This is your last chance to cancel.</p>
      </div>

      <div class="e-body">
        <p>Hi <strong><?= esc($recipient_name) ?></strong>,</p>
        <p>This is a final reminder that the deletion request for <strong><?= esc($school_name) ?></strong> expires tomorrow. After this point, the deletion cannot be undone.</p>
        ...
        <table class="e-details">
          ...
          <tr>
            ...
            <td><strong style="color:#dc2626;">Less than 24 hours</strong></td>
          </tr>
          <tr>
            <td>Status</td>
            <td><span class="badge badge-red">Deleting Tomorrow</span></td>
          </tr>
        </table>
        ...
        <div class="e-warning">
          ...
          <p><strong>This is your final warning.</strong> All data for <strong><?= esc($school_name) ?></strong> — including students, payments, attendance records, classes, and all user accounts — will be <strong>permanently and irrecoverably deleted</strong> when the grace period expires.</p>
        </div>

        <p>To prevent deletion, go to <strong>Settings → Account</strong> immediately and click <strong>"Undo Account Deletion"</strong>.</p>
      </div>

      <div class="e-cta">
        <a href="<?= esc($settings_url) ?>" class="e-btn">Cancel Deletion Now — Last Chance</a>
      </div>

      <hr class="e-divider" />

      <div class="e-body" style="padding-top:24px; padding-bottom:8px;">
        <p style="font-size:14px;color:#64748b;">Need help? Contact us immediately at <a href="mailto:<?= esc($support_email) ?>" style="color:#1e4d8c;"><?= esc($support_email) ?></a> and we'll do our best to assist you.</p>
      </div>
