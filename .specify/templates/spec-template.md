...
- **SC-005**: [Backend efficiency metric, e.g., "List/report endpoints return only the requested
  page and required summary metadata within the target response time at expected data volume"]
